...
public enum TobMistake {
    ...
    SOTETSEG_PRAYER("Sotetseg Prayer", "sot_mage_orb.png", "I got hit by a Sotetseg orb!"),
    SOTETSEG_DEATH_BALL("Sotetseg Death Ball", "sot_death_ball.png", "I got hit by a death ball!");
